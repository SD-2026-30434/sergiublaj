...
public interface OrderController {
    ...
    @PostMapping
    @Operation(summary = "Create a new order", description = "Add a new order with the provided data.")
    @ApiResponses(value = {
    ...
    OrderResponseDTO save(@RequestBody @Valid OrderRequestDTO orderRequestDTO);
    ...
    @ResponseStatus(HttpStatus.OK)
    OrderResponseDTO update(@PathVariable(name = "id") UUID id, @RequestBody @Valid OrderRequestDTO orderRequestDTO);
